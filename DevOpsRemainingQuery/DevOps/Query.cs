namespace DevOpsRemainingQuery.DevOps
{
    ...
    internal class Query : IDisposable
    {
        ...
        private WorkItemTrackingHttpClient WitClient => witClient ??= server.Connection.GetClient<WorkItemTrackingHttpClient>();
        ...
        public async Task<List<WorkItem>> GetQueryWorkItems()
        {
            ...
            return await WitClient.GetWorkItemsAsync(ids, await GetFieldReferenceNames(), result.AsOf);
        }
